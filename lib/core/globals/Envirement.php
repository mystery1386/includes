...
class Environment {
    ...
    public static function getScope() {
        if(self::has('REDIRECT_REDIRECT_SCOPE')) {
            return self::get('REDIRECT_REDIRECT_SCOPE');
        } else if(self::has('REDIRECT_SCOPE')) {
            return self::get('REDIRECT_SCOPE');
        } else if(self::has('SCOPE')) {
            return self::get('SCOPE');
        } else if(Server::has("REDIRECT_SCOPE")) {
            return Server::get("REDIRECT_SCOPE");
        } else if(Server::has("SCOPE")) {
            return Server::get("SCOPE");
        }
        return '';
    }
    ...
    public static function getIncludePath() {
        if(!isset(self::$PATHS['_INCLUDE_PATH'])) {
             ...
             */
            self::$PATHS['_INCLUDE_PATH'] = dirname(dirname(dirname(__DIR__))) . "/";
        }
